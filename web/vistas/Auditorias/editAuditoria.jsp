       ...
       <div class="exit">
        ...
        <div class="content">
            <div class="col-lg-6">
              ...
              int id=Integer.parseInt((String)request.getAttribute("Usuario"));
              Auditoria a =(Auditoria)dao.list(id);
          %>
            <h2>Modificar Auditorias</h2><br>
            <form action="ControladorAuditoria">
                Usuario:<br>
                <input class="form-control" type="text" name="txtUsuario" value="<%= a.getUsuario()%>"><br>
                Descripción: <br>
                <input class="form-control" type="text" name="txtDescripcion" value="<%= a.getDescripcion()%>"><br>
                Fecha: <br>
                <input class="form-control" type="date" name="txtFecha" value="<%= a.getFecha()%>"><br>

                <input type="hidden" name="txtid" value="<%= a.getUsuario()%>">
                <input class="add" type="submit" name="accion" value="Actualizar">
                <a class="add" href="ControladorAuditoria?accion=listar">Regresar</a>
            </form>
          </div>
